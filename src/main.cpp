...
void menu() {
  ...
  std::cout << "6. Кратчайшие пути между всеми парами вершин в графе по "
               "алгоритму Флойда-Уоршелла"
            << std::endl;
  std::cout << "7. Поиск наименьшего остовного дерева по алгоритму Прима"
            << std::endl;
  std::cout << "8. Решение задачи коммивояжера с помощью муравьиного алгоритма"
            << std::endl;
...
void SolveTravelingSalesmanProblem(GraphController &controller) {
  controller.SolveTravelingSalesmanProblem();
}
  ...
  do {
    ...
    switch (choice) {
      ...
      case 7:
        ...
        break;
      case 8:
        SolveTravelingSalesmanProblem(controller);
        break;
      case 0:
